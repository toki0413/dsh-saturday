...
test('1. 全量插件挂载：30 工具、无重名、seam 前缀齐全', async () => {
  ...
  await withServer(async (client) => {
    ...
    for (const expected of ['material.load', 'potential.relax', 'analysis.phonon', 'sampler.flow', 'workflow.screen', 'derivation.record']) {
